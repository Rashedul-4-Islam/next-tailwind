        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
                 ...
                 <Button  sx={{ color: 'black', display: 'block' }}  onClick={() => router.push('/Home/Footer')}>Footer</Button>
                </MenuItem>
            </Menu>
          </Box>
          <Typography
          ...
          <Button  sx={{ my: 2, color: 'white', display: 'block' }}  onClick={() => router.push('/Home/Footer')}>Footer</Button>
          </Box>
